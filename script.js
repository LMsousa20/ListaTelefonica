...
function pesquisarContato2() {
    ...
    if (valor) {
        ...
        let filtro = listaBaixada.filter(x => x.nome.toUpperCase().indexOf(valor.toUpperCase()) > -1)
        console.log(filtro)
        rederizar(filtro)
    } else {
...
function rederizar(listaRenderizada) {
    ...
    listaRenderizada.forEach((i) => {
        ...
        listagemtelefonica += `
        <div class="conteiner d-flex justify-content-between align-items-center">
    <div id="nome-avatar">
        <div class="d-flex justify-content-between align-items-center">
            <div class="avatar" style="background-color: ${cores[corAleatoria]} ;">${avatarLetra}</div>
            <div class="ml-4">
...
function abreModalEdicao(idList) {
    ...
    console.log(NomeEditar)
    console.log(NumeroEditar)
